...
namespace WPCordovaClassLib.Cordova.Commands
{
    public class PushPlugin : BaseCommand
    {
        ...
        {
          if (!TryDeserializeOptionsWindows(options, out this.pushOptions))
            {
        ...
        public void on(string action, string function)
        {
            if (action == "register") {
        ...
        static bool TryDeserializeOptionsWindows<T>(string options, out T result) where T : class
        {
            result = null;
            try
            {
